...
async function redness(url) {
  ...
  for (let i = 0; i < data.length; i += 3) {
    ...
    // قرمزي مشبع فقط (عارضة العرض الحمراء). الفارق r-g هو المميِّز الحاسم:
    // القرمزي ≈ (190,30,70) فيعطي r-g ≈ 160، بينما لون البشرة والعارضات البيج/البنية
    // ≈ (200,150,120) فيعطي r-g ≈ 50 فقط. عتبة 45 كانت تمرّر البشرة والعارضات البيج
    // (تحقّقنا بصرياً: صور على رقبة شخص حقيقي و"مانيكان" بيج كانت تُحسب حمراء خطأً).
    // الذهب الأصفر مُستبعد أصلاً لأن أخضره قريب جداً من أحمره.
    // المميِّز الأنظف هو موضع الأخضر من الأزرق، لا شدّة الأحمر وحدها:
    //   القرمزي (عارضة العرض) ≈ (190,30,70) → الأخضر أقل من الأزرق.
    //   البشرة/العارضة البيج    ≈ (200,150,120) → الأخضر أعلى من الأزرق بوضوح.
    // فنشترط أحمر غالباً مع أخضر لا يعلو الأزرق إلا قليلاً. هذا يمرّر العارضة الحمراء
    // حتى لو خفّ لونها بالإضاءة، ويستبعد البشرة والبيج تماماً.
