...
function buildTraySystemPrompt(catList: string): string {
  return (
    ...
    `{"pieces":[{"position":"أعلى يمين","bbox":{"x":0.0,"y":0.0,"w":0.0,"h":0.0},"name_ar":"...","category_name":"...","item_type":"...","karat":null,"metal_color":"yellow","style":[],"gemstones":[],"stone_count":null,"condition":null,"description_ar":"..."}]}\n\n` +
    `- position: وصف مكان القطعة في الصورة بالعربية (أعلى يمين، وسط، أسفل يسار…) حتى يتعرّف عليها الموظف.\n` +
    `- bbox: مستطيل يحيط بالقطعة فقط (بدون هامش زائد) كنسبة من أبعاد الصورة الكاملة، كل قيمة بين 0 و1: ` +
    `x وy هما ركن المستطيل العلوي الأيسر، وw وh هما العرض والارتفاع. يجب أن يحيط بالقطعة كاملة بإحكام دون قطع أي جزء منها ودون ضم قطعة مجاورة. هذا الحقل إلزامي دائماً ولا يجوز إغفاله أو إرجاعه null.\n` +
