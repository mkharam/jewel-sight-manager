    ...
    <div className="max-w-5xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          ارفع مجلد/صور دفعة واحدة. النظام يرفع الصور ويحللها بالذكاء الاصطناعي (اسم/فئة/عيار/وصف).
          تُحفظ كمسودات بدون فرع — تُصنّفها يدوياً لاحقاً وتضيف SKU من صفحة تعديل القطعة.
        </p>
      </div>
