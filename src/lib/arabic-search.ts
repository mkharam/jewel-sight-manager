...
const SYNONYM_GROUPS: string[][] = [
  ...
  // جمشت / بنفسجي — أشكال لهجة وكتابة متعددة (موفيا/موفي/ليلكي...) تُطابق كلها نفس المجموعة
  ["جمشت", "امشيست", "بنفسجي", "بنفسجيه", "موف", "موفي", "موفيا", "ليلكي", "ارجواني", "بمبي غامق", "amethyst"],
  // سيترين
  ...
  // وردي فاتح/باستيل — "بودرة/بودري" تعبير شائع محلياً عن اللون الوردي الفاتح الباهت
  ["وردي", "روز", "روز غولد", "بودره", "بودري", "بودريه", "باودر", "باستيل", "بمبي فاتح", "rose"],
  ["فضه", "فضي", "silver"],
