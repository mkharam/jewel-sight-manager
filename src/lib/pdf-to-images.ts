...
// يُسقط تحويل PDF بالكامل على هذه الأجهزة. لذلك المشروع مثبَّت على pdfjs-dist@4.x تحديداً —
...
//
// نُحمّلها ديناميكياً (dynamic import) فقط عند الحاجة الفعلية لتحويل PDF حتى لا تُحمَّل
